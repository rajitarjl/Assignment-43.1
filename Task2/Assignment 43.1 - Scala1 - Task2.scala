...
// COMMAND ----------
// 1. Given a list of strings - List[String] (“alpha”, “gamma”, “omega”, “zeta”, “beta”) , Create a list
...
// 2.1 Find count of all strings with length 4
// Method-1
...
// 2.2 Find count of all strings with length 4
// Method-2
...
// 3.1 Convert the list of string to a list of integers, where each string is mapped to its corresponding length
list.map(s => (s.length))
...
// 3.2 convert the list of string to a list of integers, where each string is mapped to its corresponding length
...
// 3.1 find count of all strings which contain alphabet ‘m’ 
...
// 4.1 find the count of all strings which start with the alphabet ‘a’
